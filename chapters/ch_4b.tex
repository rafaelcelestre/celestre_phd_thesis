...
\begin{figure}[!htb]
    ...
    \caption[Artificially stacked lenses - stack 1 - figure errors]{Individually measured and artificially stacked lenses forming the stack 1. The individual lenses parameters are shown in Table~\ref{tab:CDn}. Profiles calculated for a geometric aperture of $A_{\diameter}=400~\mu\text{m}$.}
...
\begin{figure}[!htb]
    ...
    \caption[Stacked lenses - stack 1 - figure errors]{Measurement of a CRL composed of the lenses L01-L10 described in Table~\ref{tab:CDn} (stack 1). Profiles calculated for a geometric aperture of $A_{\diameter}=400~\mu\text{m}$.}
    \label{fig:CDn}
\end{figure}
...
% \begin{table}[ht]
% \caption[Lens stack 1 main parameters from XSVT metrology.]{Compilation of radii, figure-, slope- errors and useful aperture for lenses L01 to L10 (stack 1) obtained with XSVT metrology.}
% \centering
% \label{tab:CDn}
% \resizebox{\columnwidth}{!}{
% \begin{tabular}{cccccccc}
% \textbf{lens}      & \textbf{radius}  & \multicolumn{3}{c}{figure errors (r.m.s) $\mu$m}  & \multicolumn{2}{c}{slope errors (r.m.s) $\mu$rad}  & \textbf{useful aperture}\\ \cline{3-5} \cline{6-7} 
% \textbf{number}    & $\mu$m           & full profile & pol. fit   & residues              & horizontal & vertical                              & $\mu$m\\ \hline \hline
% L01                &48.77   &0.84   &0.65   &0.49   &0.18   &0.13   &439\\
% L02                &48.24   &1.33   &1.15   &0.55   &0.28   &0.24   &442\\
% L03                &48.76   &0.89   &0.65   &0.63   &0.15   &0.13   &432\\
% L04                &49.20   &1.34   &1.17   &0.64   &0.18   &0.16   &435\\
% L05                &48.41   &1.06   &0.87   &0.56   &0.18   &0.14   &440\\
% L06                &48.70   &1.36   &1.05   &0.80   &0.27   &0.22   &443\\
% L07                &48.91   &0.89   &0.68   &0.52   &0.19   &0.13   &442\\
% L08                &49.23   &1.61   &1.14   &1.08   &0.26   &0.26   &447\\
% L09                &48.09   &1.14   &0.90   &0.62   &0.15   &0.15   &434\\
% L10                &48.10   &1.21   &1.04   &0.51   &0.23   & 0.19  &431\\
% \hline
% \multicolumn{2}{r}{\textbf{accumulated}:}      &    &   &   &  & &400\\
% \hline
% Stack 01           &5.60   &7.18   &6.21   &2.46   &1.37   &1.68   &400\\
% % \multicolumn{2}{r}{\textbf{quadrature-sum}:}   &    &   &   &  & & $-$\\
% \end{tabular}
% }
% \end{table}
% \begin{table}[ht]
% \caption[Lens stack 2 main parameters from XSVT metrology.]{Compilation of radii, figure-, slope- errors and useful aperture for lenses L11 to L20 (stack 2) obtained with XSVT metrology.}
% \centering
% \label{tab:CDo}
% \resizebox{\columnwidth}{!}{
% \begin{tabular}{cccccccc}
% \textbf{lens}      & \textbf{radius}  & \multicolumn{3}{c}{figure errors (r.m.s) $\mu$m}  & \multicolumn{2}{c}{slope errors (r.m.s) $\mu$rad}  & \textbf{useful aperture}\\ \cline{3-5} \cline{6-7} 
% \textbf{number}    & $\mu$m           & full profile & pol. fit   & residues              & horizontal & vertical                              & $\mu$m\\ \hline \hline
% L11                &49.05   &0.87   &0.71   &0.49   &0.15   &0.12   &440\\
% L12                &49.27   &1.36   &1.16   &0.69   &0.21   &0.20   &460\\
% L13                &48.98   &1.14   &0.92   &0.60   &0.18   &0.15   &435\\
% L14                &48.26   &1.56   &1.28   &0.78   &0.23   &0.19   &452\\
% L15                &48.25   &1.97   &1.82   &0.54   &0.30   &0.24   &444\\
% L16                &49.25   &1.11   &0.99   &0.49   &0.19   &0.17   &443\\
% L17                &48.94   &0.91   &0.72   &0.53   &0.17   &0.14   &433\\
% L18                &48.30   &1.70   &1.44   &0.71   &0.26   &0.22   &439\\
% L19                &47.78   &1.42   &1.38   &0.72   &0.15   &0.18   &419\\
% L20                &48.62   &1.07   &0.94   &0.42   &0.18   &0.18   &456\\
% \cline{1-8}
% \multicolumn{2}{r}{\textbf{accumulated}:}      &    &   &   &  & &400\\
% \hline
% Stack 02           &5.67    &9.36   &7.41   &3.87   &2.20   &1.65   &407\\
% % \multicolumn{2}{r}{\textbf{quadrature-sum}:}   &    &   &   &  & & $-$\\
% \end{tabular}
% }
% \end{table}