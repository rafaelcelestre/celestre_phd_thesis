...
% 13/11/2020 - Second round of corrections: added Thomas (new) & Ray corrections
...
The advent of storage rings specially designed to accommodate ID's marks the third generation of synchrotron light sources, from which the ESRF - European Synchrotron Research Facility (1994) in France is the pioneering machine, followed by the APS - Advanced Photon Source (1996) in the USA and the SPring-8 - Super Photon ring-8~GeV (1999) in Japan.% and PETRA-III - Positron-Elektron-Tandem-Ring-Anlage\footnote{Positron-electron tandem-ring facility.} (2009) in Germany. 
